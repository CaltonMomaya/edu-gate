...
import {
  GraduationCap, FileText, Brain, TrendingUp, LayoutDashboard, Users, BookOpen,
...
const allNavigation: NavItem[] = [
  ...
  { name: 'Analytics', href: '/analytics', icon: Brain, roles: ['admin', 'principal'] },
  ...
  { name: 'Email', href: '/email', icon: Mail, roles: ['admin'] },
  { name: 'Email Test', href: '/email/test', icon: MailCheck, roles: ['admin'] },
  { name: 'AI Analytics', href: '/ai-analytics', icon: Brain, roles: ['admin'] },
